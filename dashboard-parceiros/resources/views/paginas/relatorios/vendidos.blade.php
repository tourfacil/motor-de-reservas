...
@section('title', 'Relatório de reservas vendidas')
    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title text-dark">Relatório de <span class="text-gradient-01">reservas vendidas</span></h2>
                <div>{{ Breadcrumbs::render('app.relatorios.vendidos') }}</div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-5 text-right">
                            ...
                            {{-- <div class="form-group pl-2 m-0">
                                <a href="{{ route('app.relatorios.vendidos.download', ['type' => 'pdf', 'servicos' => $servicos_url, 'inicio' => $pp_start->format('d-m-Y'), 'final' => $pp_end->format('d-m-Y')]) }}"
                                   target="_blank" class="btn btn-secondary mr-2 line-height-inherit">Baixar PDF <i class="la la-download right"></i></a>
                                <a href="{{ route('app.relatorios.vendidos.download', ['type' => 'xls', 'servicos' => $servicos_url, 'inicio' => $pp_start->format('d-m-Y'), 'final' => $pp_end->format('d-m-Y')]) }}"
