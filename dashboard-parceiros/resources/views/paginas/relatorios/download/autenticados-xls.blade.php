...
<table>
    ...
    <tr>
        ...
        <th align="center" valign="center" height="25" bgcolor="d9d9d9">Data Validação</th>
    ...
    @foreach($reservas as $reserva)
        <tr>
            ...
            <td align="center">{{ $reserva->validacao->validado->format('d/m/Y H:i') }}</td>
