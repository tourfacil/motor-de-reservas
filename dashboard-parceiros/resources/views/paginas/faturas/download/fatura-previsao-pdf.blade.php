...
<head>
    ...
    <title>Previsão de Fatura</title>
...
<div style="margin: 0px;">
    ...
    <header class="pt-2 pb-3">
        <div class="row d-flex align-items-center text-centers">
            <div class="col-4">
                <p class="mt-0 mb-2">Período de previsão</p>
                <h4 class="font-weight-bold">{{ $inicio->format('d/m/Y') }} até {{ $final->format('d/m/Y') }}</h4>
            </div>
            <div class="col-2">
                <p class="mt-0 mb-2">Valor</p>
                <h4 class="font-weight-bold">R$ {{ formataValor($reservas->sum('valor_net')) }}</h4>
            </div>
            <div class="col-2">
                <p class="mt-0 mb-2">Quantidade vendida</p>
                <h4 class="font-weight-bold">{{ $reservas->sum('quantidade') }} Ingresso(s)</h4>
            </div>
            <div class="col-4 pl-4">
                <p class="mt-0 mb-2">Quantidade reservas</p>
                <h4 class="font-weight-bold">{{ $reservas->count() }} Reserva(s)</h4>
            </div>
        </div>
    </header>
