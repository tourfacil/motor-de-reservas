        ...
        <div class="row flex-row h-100">
            <div class="col-12 my-auto">
                <div class="password-form mx-auto">
                    ...
                    @endif
                    <form data-validate-post method="POST" action="{{ route('password.update') }}" autocomplete="off">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="email" type="email" name="email" value="{{ $email ?? old('email') }}" data-required data-min="3" title="E-mail de acesso" autocomplete="nope"
                        ...
                        <div class="form-group">
                            <label for="password" class="form-control-label">Nova senha (min 8 caracteres)</label>
                            <div class="input-group">
                                <span class="input-group-addon addon-secondary left">
                                    <i class="la la-lock"></i>
                                </span>
                                <input id="password" type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password"
                                       required data-required placeholder="Sua nova senha" title="Nova senha" data-min="8" autocomplete="nope">
                                <div class="invalid-feedback">
