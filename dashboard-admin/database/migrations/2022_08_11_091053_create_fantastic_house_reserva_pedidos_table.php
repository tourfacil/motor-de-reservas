...
class CreateFantasticHouseReservaPedidosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fantastic_house_reserva_pedidos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('fantastic_house_reserva_pedidos');
    }
}
