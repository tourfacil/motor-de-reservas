...
class CreateDreamsReservaPedidosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dreams_reserva_pedidos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dreams_reserva_pedidos');

        /**
         * REMOVE A INTEGRAÇÃO COM O DREAMS
         */
        $types = array_map(function ($item) {
            return "'{$item}'";
