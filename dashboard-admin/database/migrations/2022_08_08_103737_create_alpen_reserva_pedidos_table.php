...
class CreateAlpenReservaPedidosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('alpen_reserva_pedidos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('alpen_reserva_pedidos');
    }
}
