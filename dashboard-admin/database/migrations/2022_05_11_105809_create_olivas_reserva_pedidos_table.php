...
class CreateOlivasReservaPedidosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('olivas_reserva_pedidos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('olivas_reserva_pedidos');
    }
}
