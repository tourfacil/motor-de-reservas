...
class CreateMatriaReservaPedidosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('matria_reserva_pedidos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('matria_reserva_pedidos');
    }
}
