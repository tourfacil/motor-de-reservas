                    ...
                    let simplemde = new SimpleMDE({
                        ...
                        toolbar: [
                            ...
                            },
                            {
                                ...
                                className: "sd-md editor-title-h4",
                                title: "Título H4",
                            },
                            {
                                name: "read-more",
                                action: (editor) => editor.codemirror.replaceSelection(" {.ler-mais}"),
                                className: "sd-md editor-read-me",
                                title: "Limitador de texto (Mostrar mais)",
                            },
                            "|",
                            {
                                name: "link",
                            ...
                            {
                                name: "calendar-hours",
                                action: (editor) => editor.codemirror.replaceSelection(" {.atendimento}"),
                                className: "sd-md editor-calendar-hours",
