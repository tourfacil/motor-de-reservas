    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title text-gradient-01">Alterar senha</h2>
                <div>{{ Breadcrumbs::render('app.alterar-senha') }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-9">
            <div class="widget has-shadow">
                ...
                <div class="widget-body">
                    ...
                    <form data-validate-ajax method="POST" action="{{ route('app.alterar-senha.atualizar') }}" class="form-horizontal">
                        ...
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-lg-6">
                                <input id="password" type="password" required class="form-control" placeholder="Sua nova senha (Min. 6 caracteres)"
                                       name="password" data-required title="Nova senha" data-min="6">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-lg-6">
                                <input id="password_confirmation" type="password" required class="form-control" placeholder="Redigite sua nova senha (Min. 6 caracteres)"
