...
<head>
    ...
    <title>{{ $reserva->servico->nome }} #{{ $reserva->voucher }} - {{ ucfirst($canal_venda->site) }}</title>
        ...
        <div class="cell">
            <div class="logo clr">
                @if($inline_pdf && (env('APP_ENV') != "local"))
                    <img src="{{ public_path($logo_canal) }}" alt="Logo">
                @else
                    <img src="{{ asset($logo_canal) }}" alt="Logo">
                @endif
            </div>
            <div class="buyer">
