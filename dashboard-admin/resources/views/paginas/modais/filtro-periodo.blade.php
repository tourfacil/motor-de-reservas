                    ...
                    <div class="form-group mb-0 pr-2 pl-2">
                        <div class="row">
                            <div class="col-xl-12 mb-2">
                                <label for="date_range_periodo" class="form-control-label">Período para busca</label>
                                <div class="input-group">
                                    <span class="input-group-addon addon-secondary left"><i class="la la-calendar-check-o"></i></span>
                                    <input id="date_range_periodo" type="tel" class="form-control datepicker" placeholder="DD/MM/AAAA" required
