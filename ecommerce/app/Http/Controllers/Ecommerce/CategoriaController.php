...
class CategoriaController extends Controller
{
    ...
    public function index($destino_slug = null, $categoria_slug = null)
    {
        ...
        if($categoria == null) return $this->redirect(route('ecommerce.destino.index', [$destino_slug]));

        if($categoria->status == StatusCategoriaEnum::INATIVA) return $this->redirect(route('ecommerce.destino.index', [$destino_slug]));
