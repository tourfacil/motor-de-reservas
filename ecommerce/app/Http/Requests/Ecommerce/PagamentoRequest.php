...
class PagamentoRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'cliente.rua' => 'required|string|min:3|max:255|regex:/^[^<]*$/',
            'cliente.numero' => 'required|string|min:2|max:10|regex:/^[^<]*$/',
            'cliente.bairro' => 'required|string|min:3|max:255|regex:/^[^<]*$/',
            'cliente.cidade' => 'required|string|min:3|max:255|regex:/^[^<]*$/',
            'cliente.estado' => 'required|string|min:2|max:3|regex:/^[^<]*$/',
            'cliente.cep'    => 'required|string|min:9|max:10|regex:/^[^<]*$/',
