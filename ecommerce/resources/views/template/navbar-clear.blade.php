...
<nav class="navbar navbar-expand-lg navbar-light py-2 py-lg-0">
    <div class="container flex-row">
        ...
        <ul class="navbar-nav flex-row ml-md-auto d-lg-none">
            <li class="nav-item">
                <a class="nav-link" href="http://wa.me/{{config('site.numero_whatsapp')}}?{{config('site.whatsapp_text_message_parameter')}}" target="_blank" title="Ajuda">
        ...
        <div class="collapse navbar-collapse align-self-start mb-0 mb-md-3" id="menu-nav">
            <ul class="navbar-nav ml-md-auto dark-menu position-relative mt-3 mt-lg-0">
                <li class="nav-item mr-md-2">
                    <a class="nav-link" href="http://wa.me/{{config('site.numero_whatsapp')}}?{{config('site.whatsapp_text_message_parameter')}}" target="_blank" title="Ajuda"><i class="iconify" data-icon="jam:help"></i> Ajuda</a>
                </li>
