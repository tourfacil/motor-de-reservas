...
@if(is_array($secao_atual) && (is_null($cidade_atual)))
    @section('title', "{$secao_atual['nome']} em {$destino->nome}")
@elseif(is_array($secao_atual) && is_string($cidade_atual))
    @section('title', "{$secao_atual['nome']} em {$cidade_atual}")
@elseif(is_null($secao_atual) && is_string($cidade_atual))
    @section('title', "{$categoria->nome} em {$cidade_atual}")
@else
    @section('title', "{$categoria->nome} em {$destino->nome}")
@endif
