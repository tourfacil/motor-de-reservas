                        ...
                        @forelse($pedidos as $pedido)
                            <tr>
                                ...
                                <td class="text-center pl-0">
                                    @IF($pedido->status == TourFacil\Core\Enum\StatusPedidoEnum::AGUARDANDO)       
                                        <a href="{{ route('ecommerce.carrinho.pagamento.pix', $pedido->codigo) }}" class="btn btn-warning btn-rounded text-white border-0 pb-2 text-uppercase" title="Detalhes do pedido">
                                            Pagar PIX <i class="iconify ml-1 align-text-bottom" data-icon="jam:chevron-right"></i>
                                        </a>            
                                    @ENDIF
