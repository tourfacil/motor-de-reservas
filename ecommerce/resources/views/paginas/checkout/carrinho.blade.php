                                    ...
                                    <div class="row align-items-center mb-4 pb-1">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="text-muted mt-1">
                                                ...
                                                @IF(isTesteAB('ab', '1'))
                                                    <p class="m-0">
                                                        @FOREACH($servico_carrinho['agenda_selecionada']['variacoes'] as $variacao)
                                                            @IF(array_key_exists('quantidade', $variacao))
                                                                @IF($variacao['quantidade'] * $variacao['valor_venda'] > 0)
                                                                    {{ $variacao['quantidade'] }}x {{$variacao['variacao']}}(s) - R$ {{ formataValor($variacao['valor_venda'] * $variacao['quantidade'])}}<br>
                                                                @ENDIF
                                                            @ENDIF
                                                        @ENDFOREACH
                                                    </p>
            ...
            <script>
                ...
                window.addEventListener("load", function(event) {
                    ...
                    sweetAlert({
                        title: 'Atenção',
                        icon: 'warning',
                        text: 'As seguintes atividades foram removidas do seu carrinho por falta de disponibilidade ou alteração de valores. Consulte a atualização na página do produto: {{ $texto_indisponiveis }}\n \n',
                    }).then((result) => {
