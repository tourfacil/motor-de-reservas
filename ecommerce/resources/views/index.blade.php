...
@section('title', 'Reserve atividades e atrações turísticas em qualquer lugar do Brasil - Tour Fácil')
...
@section('body')
    ...
    <div class="novo-site">
        <p>Estamos de cara nova, <a class="ancora-novo-site" href="https://new.tourfacil.com.br/">clique aqui</a> para saber mais!</p>
    </div>
    ...
    <div data-page="Home" data-controller="HomeCtrl" data-destino="{{ route('ecommerce.destino.view') }}">
        <div class="section-home-form position-relative">
            ...
            <section class="d-flex align-items-center" data-controller="SearchBox">
                <div class="container">
                    <div class="row pt-5">
                        <div class="col-12">
                            <h1 class="text-white h2 text-center text-sm-left">Bem vindo a TourFácil</h1>
                            <h6 class="text-white h5 text-center text-sm-left">Faça a reserva das atrações de alguns dos
                                destinos turísticos mais amados do Brasil!</h6>
                        </div>
                            ...
                            <form action="{{ route('ecommerce.servico.search') }}" class="mt-4">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control" name="q" required
                                        aria-label="Pesquisar" data-required="true" data-min="3" id="search"
                                        title="Pesquisar" placeholder="em Gramado, Balneario Camboriu..."
                                        autocomplete="off" data-action="search"
                                        data-route="{{ route('ecommerce.servico.search-ajax') }}">
        ...
        @if (\TourFacil\Core\Services\Pagamento\DescontoPIXService::isDescontoPixAtivo())
            <div class="pix-desconto-header">
                <span class="emoji">🎁</span> SUPER PIX TOURFÁCIL - RESERVE AGORA E GANHE
                <span class="desconto">{{ \TourFacil\Core\Services\Pagamento\DescontoPIXService::getPixDesconto() }}% DE
                    DESCONTO
                    NO PIX</span><span class="emoji">🎁</span>
            </div>
        @endif
        ...
        @if (config('campanha.ativo') == true)
            ...
            @php
                ...
                $servicos_campanha = TourFacil\Core\Models\Servico::whereIn('id', $ids_servico)
                    ->with(['fotoPrincipal', 'categoria', 'destino', 'tags'])
                    ->get()
                    ->shuffle();
            ...
            <style>
                .owl-nav-campanha .owl-nav button.owl-prev {
                    background-color: {{ config('campanha.cor_texto_container') }};
                }
                ...
                #namorados>div>div>div.owl-nav>button.owl-prev>svg {
                    color: white;
                }

                #namorados>div>div>div.owl-nav>button.owl-next>svg {
                    color: white;
                }
            </style>
            ...
            <section class="section-servicos-populares mt-4 mb-4" id="namorados" class="namorados">
                <div class="container pt-3">
                    <h2 class="text-center font-weight-medium pb-2"
                        style="color: {{ config('campanha.cor_texto_container') }}">{{ config('campanha.titulo') }}</h2>
                            ...
                            <div class="card-servico item">
                                <a href="{{ route('ecommerce.servico.view', [$servico_destaque->destino->slug, $servico_destaque->categoria->slug, $servico_destaque->slug]) }}"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <h3 class="ellipsis-2-lines" sty style="color: {{ config('campanha.cor') }}">
                                            {{ $servico_destaque->nome }}</h3>
                                        ...
                                        <div class="mt-auto d-flex justify-content-end align-items-center card-body-price">
                                            ...
                                            <strong style="color: {{ config('campanha.cor') }}">R$
                                                {{ formataValor($servico_destaque->valor_venda) }}</strong>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto d-flex justify-content-end align-items-center card-body-price"
                                        ...
                                        @if ($servico_destaque->descontoAtivo == null)
                                            ...
                                            <strong>R$ {{ formataValor($servico_destaque->valor_venda) }}</strong>
                                        @else
                                            <span style="text-decoration: line-through;font-size: 13.5px">De R$
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                    <section class="text-center mb-5 mb-sm-0">
                        <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="lazyload"
                            data-src="{{ asset('images/icons/qualidade-home.svg') }}" alt="Qualidade Garantida">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                    <section class="text-center mb-5 mb-sm-0">
                        <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="lazyload"
                            data-src="{{ asset('images/icons/parcelamento-home.svg') }}" alt="Parcelamento Exclusivo">
                ...
                <div class="col-lg-4 d-sm-none d-lg-block">
                    <section class="text-center">
                        <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="lazyload"
                            data-src="{{ asset('images/icons/suporte-home.svg') }}" alt="Suporte">
                        <h3>Suporte</h3>
                ...
                <div class="nav-scroll-shadows" id="destino-content">
                    <div class="auto-scroll-buttons horizontal-scroll py-1">
                        @foreach ($destinos as $destino)
                            ...
                            <button data-action="trocarDestino" title="{{ $destino->nome }}"
                                data-destino="{{ $destino->slug }}"
        ...
        <div style="background-color: #8B45A8;">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-md-12 col-lg-8 d-md-flex align-items-center justify-content-center">
                        <div class="pr-md-5 pb-4 pb-md-0 text-sm-center">
                            ...
                            <p class="mt-3 mb-3 font-size-1-1">Tem alguma dúvida sobre as opções de ingressos ou<br
                                    class="d-none d-md-block"> funcionamento? Chame nossa equipe pelo WhatsApp!</p>
                            <a href="http://wa.me/{{ config('site.numero_whatsapp') }}?{{ config('site.whatsapp_text_message_parameter') }}"
                                target="_blank"
                                class="btn btn-outline-light font-weight-medium px-4 pb-2 text-uppercase btn-rounded btn-p-vertical"
            ...
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div class="col-12 col-md-5 col-lg-6">
                        <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                            class="overlay-blog d-none d-lg-block img-fluid lazyload"
                            data-src="{{ asset('images/overlay_blog.svg') }}" alt="Overlay post blog">
                        ...
                        @foreach ($midias as $midia)
                            <div class="col-4 col-md-3 mb-sm-0">
                                <a href="{{ $midia['url'] }}" title="{{ $midia['nome'] }}">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                        class="img-fluid lazyload" data-src="{{ asset($midia['logo']) }}"
                                        alt="{{ $midia['nome'] }}">
                                </a>
                            </div>
                        @endforeach
        ...
        <section class="container py-5" style="display: none;">
            <h3 class="h1 font-weight-bold mt-3 text-center font-mobile">Siga nossos passos <i
                    class="iconify align-middle d-none d-sm-inline-block" data-icon="jam:instagram"></i></h3>
            ...
            <div class="text-center">
                <a href="https://www.instagram.com/tourfaciloficial/" rel="nofollow" title="Veja nosso instagram"
                    target="_blank" class="btn btn-outline-dark btn-rounded mt-3 text-uppercase">Veja nosso instagram</a>
            </div>
        </section>
    </div> --}}
