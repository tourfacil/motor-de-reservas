        ...
        $("[data-action='comprar'], [data-action='edit-servico']").on('click', (e) => {
            ...
            result.done((response) => {
                ...
                if(response['events'].length > 0) {
                    ...
                    ServicoCtrl.loaderDatas.show("Não foi possível encontrar disponibilidade <br> para este serviço. Tente mais tarde.", true);
                }
            });
            // Mensagem de erro
            result.fail(() => {
        ...
        let html_people = `
                <div class="d-flex align-items-center justify-content-between item-age pb-4">
                    <div class="text-truncate">
                        <p class="m-0 font-weight-medium text-truncate h5">{{ variacao }}</p>
