    ...
    sendPurchase() {
        if(window.send_purchase === "true") {
            ...
            if(window.pedido['total'] == undefined || window.pedido['gtm'] == undefined) {
                ...
                window.Google.sendPurchaseGtm(window.pedido['codigo'], window.pedido['valor_total'], window.pedido['reservas'], window.pedido['cliente_email']);

            } else {

                // Envia o pedido para o Google e ADS
                window.Google.sendPurchaseGtm(window.pedido['codigo'], window.pedido['total'], window.pedido['gtm'], window.pedido['cliente_email']);
